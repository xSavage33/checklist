...
### 6. Propina voluntaria en la impresion
Implementar la **propina voluntaria** en la factura impresa.
- Debe ser una variable ajustable desde **settings**.
- Valor inicial: **7%**.

> Se adjuntara una factura de referencia con la informacion que debe mostrar.

### 7. Calculo en la factura
Multiplicar la **cantidad del producto** por el **precio unitario** y mostrar unicamente el resultado de la multiplicacion en la factura (no mostrar el valor unitario).
...
> Ejemplo: una parte en efectivo y la otra por transferencia.

### 12. Problema con la impresora
Revisar por que la impresora **a veces no imprime**.
> Ocurre con frecuencia, toca reimprimir desde las ordenes finalizadas.

### 13. Variantes tipo combo
Implementar **variantes** que funcionen como **combos**.

---

## Preguntas

### 1. Cierre de sesion en el mismo dispositivo
Si cierro la sesion de una mesera en el mismo telefono e inicio sesion con otra cuenta, **es posible que se presenten errores**?
